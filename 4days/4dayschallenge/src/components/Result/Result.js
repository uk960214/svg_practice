    ...
    return (
        <div>
            ...
            <section className='svgContainer'>
                <svg id='resultImage' width="540" height="540" viewBox='0 0 1080 1080' fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                    <rect width="1080" height="1080" fill="#5E2CA5"/>
                    <circle r="200" transform="matrix(1 0 0 -1 540 220)" fill="#B6F4F4" style={{filter: 'url(#shadow1)'}}/>
                    <circle r="150" transform="matrix(1 0 0 -1 540 220)" fill="#D2F3F2" style={{filter: 'url(#shadow2)'}}/>
                    <circle r="100" transform="matrix(1 0 0 -1 540 220)" fill="#ffffff"
                    ...
                    <g>
                        ...
                        <path d="M506.265 560.994L519.863 566.865L506.265 569.607" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M558.845 560.994L545.247 566.865L558.845 569.607" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        <circle cx="1071" cy="44" r="200" fill="#B6F4F4"
                        style={{filter: 'url(#shadow1)'}}/>
                        <circle cx="1071" cy="44" r="150" fill="#D2F3F2"
                        style={{filter: 'url(#shadow2)'}}/>
                        <circle cx="1071" cy="44" r="100" fill="white"
                        style={{filter: 'url(#shadow3)'}}/>
                        <circle cy="40" r="200" fill="#B6F4F4"
                        style={{filter: 'url(#shadow1)'}}/>
                        <circle cy="40" r="150" fill="#D2F3F2"
                        style={{filter: 'url(#shadow2)'}}/>
                        <circle cy="40" r="100" fill="white"
                        style={{filter: 'url(#shadow3)'}}/>
                    ...
                    <text text-anchor="middle" dx="50%" dy="90%" width='1080' fill='#f4f4f4' fontSize='48px' fontWeight='750'>김요욱님도 주4일제를 위한 원기옥 모으는 중!</text>
                </g>
                <defs>
                    <clipPath id="clip0">
